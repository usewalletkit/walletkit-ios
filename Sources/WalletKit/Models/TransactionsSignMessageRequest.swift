//
// TransactionsSignMessageRequest.swift
//
...
public struct TransactionsSignMessageRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(network: Network, signerWalletAddress: String, message: String, developerSecret: String? = nil, userPin: String? = nil) {
